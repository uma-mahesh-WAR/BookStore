				...
				<form className="form" onSubmit={submitBook}>
					<div className="form-group">
						...
						>
							...
							<option style={{ backgroundColor: "#b1b6bb" }} value="noAuthor" disabled>
					...
					<div className="form-group">
						...
						>
							...
							<option style={{ backgroundColor: "#b1b6bb" }} value="noCategory" disabled>
							...
							onChange={async (e) => {
								try {
									...
									if (convertedImage) {
										...
										this.setState({
											imgmsg: "The file is not in format of image/jpeg or image/png",
										});
									}
								} catch (error) {
									this.setState({
					...
					<div className="form-group">
						<button type="submit" style={{ margin: "10px 10px 0 0" }} className="btn btn-secondary">
							ADD/UPDATE
						</button>
					</div>
